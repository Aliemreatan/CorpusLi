...
This module uses BERT or other backends to update lemma information in the corpus database.
It iterates through all sentences, processes them, and updates the lemma for each token.
"""
